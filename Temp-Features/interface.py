...
#Background Image
bgimg = tk.PhotoImage(file = "../Resources/new_background.png")
...
profile_gui = tk.PhotoImage(file = "../Resources/profile_ui.png")
canvas.create_image(20,20,anchor=NW,image=profile_gui)

profile_pic_frame_tk = tk.PhotoImage(file = "../Resources/pic_frame.png")
canvas.create_image(58,58,anchor=NW,image=profile_pic_frame_tk)

profile_pic_tk = tk.PhotoImage(file = "../Resources/no_pic.png")
profile_pic = canvas.create_image(60,60,anchor=NW,image=profile_pic_tk)
...
minute_label= Label(window, width=3, font=("Arial",14,"" , ), fg="#FFFFFF",
                   textvariable=minute, background="#917FB3")
minute_label.place(x=500,y=90)

seperate_time= Label(window, width=1, font=("Arial",14,"" , ), fg="#FFFFFF",
                   text=':',background="#917FB3")
seperate_time.place(x=530,y=90)

second_label= Label(window, width=2, font=("Arial",14,""), fg="#FFFFFF",
...
if waiver_available:
    ...
    minute_label_waiver= Label(window, width=3, font=("Arial",14,"" , ), fg="#FFFFFF",
                       textvariable=minute_waiver, background="#917FB3")
    minute_label_waiver.place(x=400,y=90)

    seperate_time_waiver= Label(window, width=1, font=("Arial",14,"" , ), fg="#FFFFFF",
                       text=':',background="#917FB3")
    seperate_time_waiver.place(x=430,y=90)

    second_label_waiver= Label(window, width=2, font=("Arial",14,""), fg="#FFFFFF",
...
start_btn = Button(window, text='Start Exam', bd='5',fg="#FFFFFF" ,bg='#910ac2',font=("Calibri", 16 * -1),
                   activebackground='#917FB3',height='1',width='14',command= start_timers)
start_btn.place(x = 650,y = 90)



face_recognition_btn = Button(window, text='Face Recognition', bd='5',fg="#FFFFFF" ,bg='#910ac2',
