...
# open login screen
# relevant parameters: window.room - room number , window.exam - exam number , window.cam - camera chosen
App = QApplication(sys.argv)
window = LoginScreen.MainWindow()
temp = App.exec()


exam_number = window.exam
room_number = window.room
...
cap = cv2.VideoCapture(window.cam)
cap.set(3, 640)
cap.set(4, 480)
